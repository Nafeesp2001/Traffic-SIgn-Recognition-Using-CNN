import numpy as np # For converting images to numpy array
...
path = '/Desktop/myData'  # folder with all the class folders
labelFile = '/traffic-sign/labels.csv'  # file with all names of classes
batch_size_val = 50  # how many to process together
steps_per_epoch_val = 700
epochs_val = 10
...
pickle_out = open("/traffic-sign/model_trained3.p", "wb")  # wb = WRITE BYTE
